...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default=DATA_PATH, help="Path to the input Excel file.")
    parser.add_argument("--output", type=str, default=OUTPUT_PATH, help="Path to save the SHAP output CSV file.")
